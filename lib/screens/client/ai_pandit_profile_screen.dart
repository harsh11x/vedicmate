                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              pandit.publicSpecializations.join(" • "),
                              style: GoogleFonts.outfit(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        AppTheme.divineGold.withOpacity(0.12),
                            ...
                            if (pandit.publicSpecializations.isNotEmpty) ...[
                              const SizedBox(height: 12),
                              Wrap(
                                spacing: 8,
                                runSpacing: 8,
                                children: pandit.publicSpecializations
                                    .map((s) => Container(
                                          padding: const EdgeInsets.symmetric(
                            ...
                            Row(
                              children: [
                                Icon(Icons.menu_book_rounded,
                                    size: 20, color: AppTheme.divineGold),
                  ...
                  Expanded(
                    child: OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        ...
                        side:
                            BorderSide(color: AppTheme.divineGold, width: 1.5),
