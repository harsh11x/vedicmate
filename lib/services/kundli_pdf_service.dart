...
class KundliPdfService {
  ...
  static pw.Widget _buildFooter() => pw.Column(children: [pw.Divider(color: PdfColors.grey300), pw.SizedBox(height: 3), pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [pw.Text('Generated via Vedic Mate App', style: pw.TextStyle(fontSize: 7, color: PdfColors.grey500)), pw.Text('www.vedicmate.com', style: pw.TextStyle(fontSize: 7, color: primaryColor))])]);
